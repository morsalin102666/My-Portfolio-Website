...
const Project = () => {
    return (
        <div id='projects' className="px-[4%] md:px-[6%] lg:px-[10%] pb-12 md:py-[200px] bg-[#2C2C6C]">
                ...
                <div data-aos="zoom-in"
                    ...
                    <div className='w-[55%] p-2 text-white'>
                        ...
                        <div className='flex justify-between mt-[50px]'>
                            <button data-aos="zoom-in" data-aos-duration="2000" className="btn btn-outline px-2 md:px-[10px] mr-1 btn-primary rounded-md ">View Code</button>
                            <Link to={'https://toys-client-site.web.app/'}>
                                <button data-aos="zoom-in" data-aos-duration="2000" className="btn btn-outline btn-primary px-[12px] md:px-[17px] rounded-md ">Live site</button>
                            </Link>
                        </div>
                    </div>
                </div>
